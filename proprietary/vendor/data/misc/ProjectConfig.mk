...
CUSTOM_HAL_IMGSENSOR = ov13856_mipi_raw ov8856_mipi_raw
CUSTOM_HAL_LENS = dw9718af dummy_lens
CUSTOM_HAL_MAIN2_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_LENS =
CUSTOM_HAL_MAIN_IMGSENSOR = ov13856_mipi_raw
...
CUSTOM_KERNEL_CAM_CAL = s5k2p8_eeprom ov8858_eeprom
...
CUSTOM_KERNEL_IMGSENSOR = ov13856_mipi_raw ov8856_mipi_raw
...
CUSTOM_KERNEL_MAIN_IMGSENSOR = ov13856_mipi_raw
...
CUSTOM_MODEM=mt6750_sp_lwctg_mp5_umoly0070_prod
...
# [houjihai start] Close mtk background power saving feature
...
# [zhangdong] transport lk/kernel driver for chargeIC
MTK_BQ2560X_SUPPORT = yes
MTK_BRANCH = alps-mp-o1.mp3
...
MTK_BUILD_VERNO = alps-mp-o1.mp3-V1.65_k50v1.64_P16
MTK_BWC_SUPPORT = yes
MTK_CACHE_MERGE_SUPPORT = no
# [houjihai start] remove mtk calendar importer app
...
# [wuhefeng] only one mic in TP910
...
# [houjihai start] remove mtk file manager app
...
# [yanlin] Rotate 180 degree using MTK_LCM_PHYSICAL_ROTATION_HW
...
# [houjihai start] Close NFC OMAAC support
...
# [jiangtingyu start] replace default keys
...
# [liguanxiong start] Modify for rongcard tee setup
MTK_TEE_SUPPORT = yes
# [liguanxiong end]
...
# [houjihai start] remove duraSpeed function
...
# [liguanxiong start] disable dtbo feature
MTK_DTBO_FEATURE = no
# [liguanxiong end]
MNTL_SUPPORT = no
...
MTK_NET_RFC7217 = no
# [yanlin] Use vendor oritentation
...
MTK_SWIP_WMAPRO = no
# [Luo Dinglun start]
ifeq ($(LCM_HEIGHT)_$(LCM_WIDTH),1920_1080)
  BOOT_LOGO = tplink1080
...
MTK_PERSIST_EXTERNAL_SIM = no
MTK_EXTERNAL_SIM_RSIM_ENHANCEMENT = no
